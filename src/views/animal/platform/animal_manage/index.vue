...
import { SearchParams, PlatformPostList } from '@/views/animal/platform/animal_manage/types'
import { getPlatformPostListApi } from '@/views/animal/platform/animal_manage/animal.api'
